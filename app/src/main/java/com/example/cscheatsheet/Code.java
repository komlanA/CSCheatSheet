...
public class Code {
    ...
    //default settings
    // The number of default random numbers in the verification code
...
//        c.save( Canvas.ALL_SAVE_FLAG );//save
    ...
    private void randomTextStyle(Paint paint) {
        ...
        paint.setTextSkewX(skewX); //Float type parameter, negative number means right slant, integer left slant
        //paint.setUnderlineText(true); //true is an underline, false is a non-underline
