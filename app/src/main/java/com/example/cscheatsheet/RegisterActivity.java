...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Display the verification code in the form of a picture
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_registeractivity_register:    //Register button
                // Get the user name, password, and verification code entered by the user
                ...
                if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(userInputCode) ) {
                    if (userInputCode.equals(realCode)) {
