  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Flashcard` (`uuid` TEXT NOT NULL, `question` TEXT NOT NULL, `answer` TEXT, `wrong_answer_1` TEXT, `wrong_answer_2` TEXT, PRIMARY KEY(`uuid`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0d938e6c5ec7556bd68d35fd38a5fddc')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsFlashcard.put("answer", new TableInfo.Column("answer", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoFlashcard.equals(_existingFlashcard)) {
          return new RoomOpenHelper.ValidationResult(false, "Flashcard(com.example.cscheatsheet.fragments.flashcards.Flashcard).\n"
                  + " Expected:\n" + _infoFlashcard + "\n"
                  + " Found:\n" + _existingFlashcard);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "0d938e6c5ec7556bd68d35fd38a5fddc", "71105f09d3304cf6717dfcbcba6e64a8");
